...
public class EmployeeApplication extends javax.swing.JFrame
{
    ...
    private ArrayList<Employee> arEmp = new ArrayList();
    ...
    private void initComponents() {
        ...
        setTitle("Employee Form - Lehlohonolo Mononyane");
    ...
    {//GEN-HEADEREND:event_btnSaveActionPerformed
        ...
        try
        {
            ...
            homeAddress = new Address(street,town);
            objEmp = new Employee(name, salary, homeAddress);  //might raise IllegalArgumentException
            arEmp.add(objEmp);
            ...
            txtStreet.setText("");
            txtTown.setText("");
            lblSaveMsg.setText(name + " saved successfull");
        }
    ...
    {//GEN-HEADEREND:event_btnDisplaySelectedActionPerformed
        ...
        if (position >= 0 && position < arEmp.size())
        {
            objEmp = arEmp.get(position);

            txtData.setText("Name:" + objEmp.getName()
                    + "\nSalary: R" + String.format("%5.2f", objEmp.getSalary()) + "\nStreet: " + objEmp.getHomeAddress().getStreet()+ "\nTown: " + objEmp.getHomeAddress().getTown());
    ...
    {//GEN-HEADEREND:event_btnHighestActionPerformed
        ...
        highPosition = 0;
        for (int i = 1; i < arEmp.size(); i++)
        {
            if (arEmp.get(i).getSalary() > arEmp.get(highPosition).getSalary())
            {
                highPosition = i;
            }
        }

        objEmp = arEmp.get(highPosition);
        txtData.setText("Name:" + objEmp.getName()
    ...
    private void showAllEmployees()
    {
        ...
        String[] arNames = new String[arEmp.size()];

        //load all the names in the array
        for (int i = 0; i < arNames.length; i++)
        {
            arNames[i] = arEmp.get(i).getName();
        }
